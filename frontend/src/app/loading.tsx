    ...
    <div className="fixed inset-0 flex items-center justify-center bg-background/95 backdrop-blur-sm z-50">
      <div className="text-center">
        ...
        <div className="relative mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-accent/20 border border-accent/30 mb-6 animate-pulse">
          ...
          <div className="absolute inset-2 rounded-full border border-accent/10 animate-spin animation-reverse"></div>
          <div className="absolute inset-4 rounded-full border border-accent/5 animate-spin"></div>
        </div>
        ...
        <div>
          ...
          <p className="text-border-light text-sm md:text-base mb-4">
            Chargement en cours...
          </p>
