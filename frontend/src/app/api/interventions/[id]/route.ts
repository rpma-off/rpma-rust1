 ...
 * R̩cup̬re les d̩tails complets d'une intervention PPF
 * @version 2.0
 * @date 2025-01-20
 */
...
export async function GET(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // 3. R̩cup̩ration des param̬tres de requ̻te
    ...
    // 4. Appel du service m̩tier
    const workflowService = interventionWorkflowService;

    // R̩cup̩ration de l'intervention de base
    ...
    // 5. Enrichissement conditionnel des donn̩es
    ...
    // R̩cup̩ration des ̩tapes si demand̩es
    if (includeSteps) {
    ...
    // R̩cup̩ration des photos si demand̩es
    if (includePhotos) {
      // TODO: Appel au service photo pour r̩cup̩rer toutes les photos
      responseData.photos = [];
    }

    // R̩cup̩ration des m̩triques si demand̩es
    if (includeMetrics) {
      // TODO: Appel au service m̩triques
