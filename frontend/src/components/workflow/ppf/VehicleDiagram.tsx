...
import { cn } from '@/lib/utils'; // Assuming standard shadcn utils exist based on architecture
...
// --- Zone Configuration ---
// Mapping friendly names for the UI
...
export function VehicleDiagram({ defects, onDefectAdd, onDefectRemove, readOnly = false }: VehicleDiagramProps) {
  ...
  // Helper to determine zone styling based on defects
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      {/* SVG Diagram - Horizontal Orientation (Left = Front) */}
      <div className="relative w-full max-w-2xl aspect-[2/1] bg-zinc-950/50 rounded-xl border border-white/5 p-4 shadow-2xl">
        ...
        >
          {/* --- Non-Interactive Visual Context (Glass, Wheels) --- */}
          <g className="pointer-events-none">
             {/* Wheels (simplified positions) */}
          ...
          >
            ...
            {/* 3. Windshield (Visual Only - Glass color) */}
            <path
            ...
            {/* --- Top Side (Left from driver perspective) --- */}
            {/* Left Front Fender */}
            <path
            ...
            {/* --- Bottom Side (Right from driver perspective) --- */}
            {/* Right Front Fender */}
            <path
        ...
        {/* Dynamic Label Overlay (Optional visual reinforcement) */}
