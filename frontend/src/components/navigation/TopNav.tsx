...
export function TopNav({
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center w-full shrink-0">
      {/* Logo and Brand */}
      <div className="flex items-center px-4 lg:px-6 min-w-0">
        <div className="flex items-center ml-2 lg:ml-0">
          <span className="text-xl font-bold text-gray-900 hidden sm:inline">RPMA</span>
        </div>
      </div>

      {/* Search Bar - Centered on Desktop, Right on Mobile */}
      <div className="flex-1 max-w-md mx-4 lg:mx-8 min-w-0">
        <div
