...
const TaskHeader: React.FC<TaskHeaderProps> = ({
  ...
  return (
    <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-[hsl(var(--rpma-border))] bg-gradient-to-r from-muted to-background">
      <div className="flex flex-col space-y-2 sm:space-y-0">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-sm">
            ...
            <div
              className={`flex items-center px-2.5 py-1 rounded-full border ${
                isAssignedToCurrentUser
                  ...
                  : 'bg-white border-[hsl(var(--rpma-border))] text-muted-foreground-light'
              }`}
            >
          ...
          {task.workflow_status && (
            <div className="hidden sm:flex items-center text-muted-foreground-light bg-white px-2 py-1 rounded-md">
