          ...
          <div className="flex items-center justify-between gap-2 md:gap-3 flex-nowrap">
            ...
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              ...
              <div className="flex md:hidden items-center gap-1">
                <Button
                  size="sm"
                  className="h-8 px-3 bg-[hsl(var(--rpma-teal))] hover:bg-[hsl(var(--rpma-teal))]/90 text-white font-medium"
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <Button
                  size="sm"
                  className="bg-[hsl(var(--rpma-teal))] hover:bg-[hsl(var(--rpma-teal))]/90 text-white font-medium"
                  onClick={() => setCreateDialogOpen(true)}
                >
