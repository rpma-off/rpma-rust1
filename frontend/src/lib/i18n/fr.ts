export const fr = {
  ...
  clients: {
    ...
    customerTypeRequired: "Type de client *",
    ...
    backToClient: "Retour à {name}",
    clientNotFound: "Client non trouvé",
    checkClientId: "Veuillez vérifier l'identifiant du client ou réessayer plus tard.",
  ...
  inventory: {
    ...
    materialCatalog: "Catalogue de matériaux",
    manageMaterials: "Gérez vos matériaux et fournitures PPF",
