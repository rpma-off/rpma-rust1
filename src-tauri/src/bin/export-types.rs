...
use rpma_ppf_intervention::models::{
    ...
    reports::{
        ...
        InterventionReportResult, KpiCategory, MaterialConsumption as ReportsMaterialConsumption,
        ...
        QualityIssue, QualitySummary, QualityTrend, ReportFilters, ReportMetadata, ReportRequest,
