...
mod tests {
    ...
    fn test_create_stock_in_transaction() {
        ...
        assert_eq!(
            ...
            Some("Purchase Order".to_string())
        );
        assert_eq!(transaction.unit_cost, Some(15.50));
        assert_eq!(transaction.warehouse_id, Some("WH-001".to_string()));
        assert_eq!(transaction.location_to, Some("Rack A-1".to_string()));
        assert_eq!(transaction.batch_number, Some("BATCH-001".to_string()));
        assert_eq!(transaction.quality_status, Some("Good".to_string()));
    ...
    fn test_create_stock_out_transaction() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            notes: Some("Material sold to customer".to_string()),
            unit_cost: None,
            warehouse_id: Some("WH-001".to_string()),
        ...
        assert_eq!(transaction.reference_number, Some("SO-001".to_string()));
        assert_eq!(transaction.location_from, Some("Rack A-1".to_string()));
    ...
    fn test_create_transfer_transaction() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            unit_cost: None,
            warehouse_id: Some("WH-001".to_string()),
            location_from: Some("WH-001-Rack-A".to_string()),
            location_to: Some("WH-002-Rack-B".to_string()),
            batch_number: None,
            expiry_date: None,
            quality_status: None,
            intervention_id: None,
        ...
        assert_eq!(transaction.location_from, Some("WH-001-Rack-A".to_string()));
        assert_eq!(transaction.location_to, Some("WH-002-Rack-B".to_string()));
    ...
    fn test_create_waste_transaction() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            notes: Some("Damaged during installation".to_string()),
            unit_cost: None,
            warehouse_id: Some("WH-001".to_string()),
            location_from: Some("Rack A-1".to_string()),
            location_to: None,
    ...
    fn test_create_consumption_transaction() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            notes: Some("Used in PPF installation".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
            ...
            expiry_date: None,
            quality_status: None,
            intervention_id: Some("intervention-001".to_string()),
        ...
        assert_eq!(
            ...
            Some("intervention-001".to_string())
        );
    ...
    fn test_transaction_insufficient_stock_error() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            reference_number: Some("SO-002".to_string()),
            reference_type: Some("Sales Order".to_string()),
            notes: Some("Attempt to exceed stock".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
    ...
    fn test_transaction_material_not_found() {
        ...
        let request = CreateInventoryTransactionRequest {
            ...
            reference_type: Some("Purchase Order".to_string()),
            notes: Some("Test with non-existent material".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
    ...
    fn test_get_transaction_history() {
        ...
        for i in 1..=5 {
            let request = CreateInventoryTransactionRequest {
                ...
                reference_type: Some("Test Transaction".to_string()),
            ...
            service
                .create_inventory_transaction(request, Some("test_user".to_string()))
                .unwrap();
        }
    ...
    fn test_get_inventory_movement_summary() {
        ...
        let stock_in = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockIn,
            quantity: 100.0,
            reference_number: Some("PO-SUMMARY".to_string()),
            reference_type: Some("Purchase Order".to_string()),
            notes: None,
            unit_cost: Some(15.50),
            warehouse_id: None,
        ...
        let stock_out = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 20.0,
            reference_number: Some("SO-SUMMARY".to_string()),
            reference_type: Some("Sales Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
        ...
        service
            .create_inventory_transaction(stock_out, Some("test_user".to_string()))
            .unwrap();
        ...
        let waste = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::Waste,
            quantity: 5.0,
            reference_number: Some("WASTE-SUMMARY".to_string()),
            reference_type: Some("Material Waste".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
    ...
    fn test_transaction_rollback_adjustment_to_previous_stock() {
        ...
        let stock_out = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 30.0,
            reference_number: Some("SO-ROLLBACK".to_string()),
            reference_type: Some("Sales Order".to_string()),
        ...
        let adjustment = CreateInventoryTransactionRequest {
            ...
            reference_number: Some("RETURN-ADJ".to_string()),
            reference_type: Some("Customer Return".to_string()),
            notes: Some("Customer returned the material".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
            batch_number: None,
            expiry_date: None,
            quality_status: Some("Returned".to_string()),
            intervention_id: None,
            step_id: None,
        };
        service
            .create_inventory_transaction(adjustment, Some("test_user".to_string()))
            .unwrap();
    ...
    fn test_transaction_rollback_with_negative_adjustment() {
        ...
        let stock_in = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockIn,
            quantity: 25.0,
            reference_number: Some("PO-MISTAKE".to_string()),
            reference_type: Some("Purchase Order".to_string()),
            notes: Some("Recorded by mistake".to_string()),
            unit_cost: Some(10.0),
            warehouse_id: None,
            location_from: None,
            location_to: None,
        ...
        let adjustment = CreateInventoryTransactionRequest {
            ...
            reference_number: Some("CORRECTION-ADJ".to_string()),
            reference_type: Some("Inventory Correction".to_string()),
            notes: Some("Correcting previous mistake".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
            batch_number: None,
            expiry_date: None,
            quality_status: Some("Corrected".to_string()),
            intervention_id: None,
            step_id: None,
        };
        service
    ...
    fn test_concurrent_transactions_same_material() {
        ...
        let stock_out1 = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 10.0,
            reference_number: Some("CONCURRENT-1".to_string()),
        ...
        let stock_out2 = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 15.0,
            reference_number: Some("CONCURRENT-2".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
        ...
        let stock_out3 = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 20.0,
            reference_number: Some("CONCURRENT-3".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
        ...
        service
            .create_inventory_transaction(stock_out3, Some("test_user".to_string()))
            .unwrap();
    ...
    fn test_concurrent_transactions_insufficient_stock_later() {
        ...
        let stock_out1 = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 30.0,
            reference_number: Some("CONCURRENT-SUCCESS".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
        ...
        let stock_out2 = CreateInventoryTransactionRequest {
            ...
            reference_number: Some("CONCURRENT-FAIL".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
    ...
    fn test_transaction_reporting_by_date_range() {
        ...
        let stock_in = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockIn,
            quantity: 50.0,
            reference_number: Some("PO-REPORTING".to_string()),
            reference_type: Some("Purchase Order".to_string()),
        ...
        let stock_out = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 15.0,
            reference_number: Some("SO-REPORTING".to_string()),
            reference_type: Some("Sales Order".to_string()),
            notes: Some("Customer order".to_string()),
            unit_cost: None,
            warehouse_id: None,
    ...
    fn test_transaction_reporting_by_type() {
        ...
        let stock_in = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockIn,
            quantity: 50.0,
            reference_number: Some("PO-TYPE".to_string()),
            reference_type: Some("Purchase Order".to_string()),
            notes: None,
            unit_cost: Some(10.0),
            warehouse_id: None,
        ...
        let waste = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::Waste,
            quantity: 5.0,
            reference_number: Some("WASTE-TYPE".to_string()),
            reference_type: Some("Material Waste".to_string()),
            notes: Some("Damaged material".to_string()),
            unit_cost: None,
            warehouse_id: None,
            location_from: None,
            location_to: None,
    ...
    fn test_error_recovery_invalid_transaction_type() {
        ...
        let stock_out_invalid = CreateInventoryTransactionRequest {
            ...
            reference_number: Some("INVALID-TX".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
    ...
    fn test_error_recovery_partial_transaction_rollback() {
        ...
        let stock_out_success = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 25.0,
            reference_number: Some("SUCCESS-TX".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
        ...
        let stock_out_fail = CreateInventoryTransactionRequest {
            ...
            transaction_type: InventoryTransactionType::StockOut,
            quantity: 100.0, // More than available
            reference_number: Some("FAIL-TX".to_string()),
            reference_type: Some("Order".to_string()),
            notes: None,
            unit_cost: None,
            warehouse_id: None,
