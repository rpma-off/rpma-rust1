...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::material::material_delete,
            commands::material::material_update_stock,
            commands::material::material_adjust_stock,
            commands::material::material_record_consumption,
            commands::material::material_get_consumption_history,
            commands::material::material_get_intervention_consumption,
            commands::material::material_get_intervention_summary,
            commands::material::material_create_inventory_transaction,
            commands::material::material_get_transaction_history,
            commands::material::material_create_category,
            commands::material::material_list_categories,
            commands::material::material_create_supplier,
            commands::material::material_list_suppliers,
            commands::material::material_get_stats,
            commands::material::material_get_low_stock,
            commands::material::material_get_expired,
            commands::material::material_get_low_stock_materials,
            commands::material::material_get_expired_materials,
            commands::material::material_get_inventory_movement_summary,
            commands::material::inventory_get_stats,
            ...
            domains::auth::ipc::auth::auth_refresh_token,
            domains::auth::ipc::auth::enable_2fa,
            domains::auth::ipc::auth::verify_2fa_setup,
            domains::auth::ipc::auth::disable_2fa,
            domains::auth::ipc::auth::verify_2fa_code,
            domains::auth::ipc::auth::is_2fa_enabled,
            domains::auth::ipc::auth::regenerate_backup_codes,
