...
> {
    ...
    let intervention_data = crate::domains::interventions::infrastructure::intervention_types::StartInterventionRequest {
...
pub async fn intervention_finalize(
    ...
    session_token: String,
    state: AppState<'_>,
) -> Result<ApiResponse<crate::domains::interventions::infrastructure::intervention_types::FinalizeInterventionResponse>, AppError>
{
    ...
    let finalize_data = crate::domains::interventions::infrastructure::intervention_types::FinalizeInterventionRequest {
...
pub async fn intervention_workflow(
    ...
    match action {
        InterventionWorkflowAction::Start { data } => {
            ...
            let service_request = crate::domains::interventions::infrastructure::intervention_types::StartInterventionRequest {
