//! Scaffolded unit test plan for `interventions` domain services.
//!
//! Oracle references:
...
mod scaffold {
    ...
    #[test]
    #[ignore = "Scaffold placeholder: replace with allowed/denied transition assertions for `validate_transition`"]
    fn test_validate_transition_status_transition_guards() {
        panic!("Scaffold placeholder for status guard `validate_transition`");
    }
