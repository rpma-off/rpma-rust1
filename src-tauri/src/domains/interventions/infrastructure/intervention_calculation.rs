...
impl InterventionCalculationService {
    ...
    pub fn calculate_final_metrics(
        ...
        // Uses intervention-level fields to produce consistent metrics without
        // requiring a separate step-query roundtrip in this calculation path.
        ...
        // Return deterministic metrics derived from persisted intervention data.
