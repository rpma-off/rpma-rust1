...
pub struct AppStateType {
    ...
    pub dashboard_service:
        Arc<crate::domains::analytics::infrastructure::dashboard::DashboardService>,
    ...
    pub prediction_service:
        Arc<crate::domains::analytics::infrastructure::prediction::PredictionService>,
...
impl AppStateType {
    pub fn report_job_service(
        &self,
    ) -> &Arc<crate::domains::reports::infrastructure::report_jobs::ReportJobService> {
        self.report_job_service.get_or_init(|| {
            Arc::new(
                crate::domains::reports::infrastructure::report_jobs::ReportJobService::new(
                    self.db.clone(),
